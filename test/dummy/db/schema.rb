...
ActiveRecord::Schema[7.2].define(version: 2025_05_26_153546) do
  ...
  create_table "stepper_motor_scheduled_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["journey_id", "idempotency_key"], name: "idx_on_journey_id_idempotency_key_01b9a1d966", unique: true
    t.index ["journey_id"], name: "index_stepper_motor_scheduled_tasks_on_journey_id"
  end

  add_foreign_key "stepper_motor_scheduled_tasks", "stepper_motor_journeys", column: "journey_id", on_delete: :cascade
end
